...
% --- Cuerpo del reporte ---
	...
	de voltaje, corriente y potencia para cada resistencia, el desarrollo se encuentra en el Apéndice \ref{apx:1}.

	Para la medicón de los valores mencionados, se usó un multímetro digital y un par de cables con conexión banana-caiman.\\
	...
	por la corriente. Los resultados se muestran en la siguiente tabla:
	...
	\begin{table}[h!]
		...
		\end{tabular}
		\caption{
			Tabla con los valores medidos de resistencia, voltaje, corriente y
	...
	posibles errores.
	AUNQUE SE USARON DIFERENTES RESISTENCIAS (TEORICO Y EXPERIMENTAL) SE OBTUVO UN ORDENAMIENTO SIMILAR, VALORES ALTOS EN LAS PRIMERAS QUE DIMUNUYE A MEDIDA QU EL CIRCUITO AVANZA
